...
export default function AboutUs() {
  return (
    <div className="relative mx-auto w-full flex justify-center">
      <div className="flex w-full relative max-w-[1800px] h-screen max-[1250px]:h-[650px] max-[1250px]:flex-col">
        ...
        <div className="absolute flex right-[-240px] h-[528px] top-[60px] z-10 min-[1251px]:hidden max-[670px]:top-[500px] max-[450px]:top-[550px] max-[670px]:right-[-200px] max-[400px]:top-[350px]">
          <Image className="select-none" priority={true} style={{objectFit: "contain"}} src={Vector4} alt=""/>
        </div>
        <div className="absolute flex right-[-320px] h-[528px] top-[60px] max-[670px]:top-[550px] max-[670px]:right-[-280px] max-[400px]:top-[360px]">
