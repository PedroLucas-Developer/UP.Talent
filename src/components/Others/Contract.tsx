  ...
  return (
    <div  className="relative flex justify-center flex-col">
      ...
      <div className='max-[1250px]:bg-[#df887c] pb-[150px]'>
        <div className='pt-[220px] relative mx-auto w-11/12 max-w-[1270px] max-[1250px]:pt-[50px]'>
          <div className='flex w-full flex-row justify-between max-[1250px]:flex-col'>
            <div className='flex flex-row justify-between w-[812px] max-[1250px]:w-full max-[600px]:flex-col'>
              <div className="w-[272px] mb-auto flex flex-col justify-center max-[1250px]:w-1/2 max-[600px]:w-full">
                <div className="flex mx-auto">
                  <div className='h-[280px] max-[1250px]:h-[250px]'>
                    <Image loading="lazy" src={Caledar} alt="" />
                  </div>
                </div>
                <div className="flex flex-col justify-center mx-auto">
                  <p className="text-[40px] text-[#FFFFFF] leading-[40px] font-bold text-center max-[1250px]:text-[35px]">
                    Job Pontual
                  </p>
                  <p className="text-[30px] mt-12 text-[#FFFFFF] leading-[40px] text-center max-[1250px]:mt-4 max-[1250px]:text-[25px]">
                    Contrato pot vaga
                  </p>
                </div>
              </div>
              <div className="w-[353px] mb-auto flex flex-col justify-center max-[1250px]:w-1/2 max-[600px]:w-full max-[600px]:pt-10">
                <div className="flex mx-auto">
                  <div className='h-[280px] max-[1250px]:h-[250px]'>
            ...
            <div className="w-[353px] ml-[50px] mb-auto flex flex-col justify-center  max-[1250px]:ml-0 max-[1250px]:pt-10 max-[1250px]:w-full">
              <div className="flex mx-auto">
                <div className='pt-4 h-[280px] max-[1250px]:h-[250px]'>
