      ...
      <div className='w-11/12 flex flex-row mx-auto max-w-[1400px] mt-[140px] max-[1550px]:mt-[200px] max-[1550px]:flex-col'>
        <div className='flex flex-row max-[1250px]:flex-col mx-auto  max-[1250px]:w-full'>
          <div className='flex flex-row max-[550px]:flex-col max-[1250px]:w-full max-[1250px]:justify-between'>
            ...
            <div className="w-[209px] ml-[95px] flex flex-col max-[1250px]:mx-auto max-[550px]:mx-auto justify-center">
              <div className="flex mx-auto h-[160px]">
          ...
          <div className="w-[252px] ml-[70px] flex flex-col max-[1250px]:mx-auto max-[1250px]:mt-8 justify-center">
            <div className="flex mx-auto h-[160px]">
        ...
        <div className='flex flex-row max-[550px]:flex-col max-[1550px]:mt-8 mx-auto max-[1250px]:w-full max-[1250px]:justify-between'>
          <div className="w-[260px] ml-[85px] max-[1550px]:ml-0 flex flex-col max-[550px]:mx-auto justify-center max-[1250px]:w-1/2">
            <div className="flex mx-auto h-[160px]">
          ...
          <div className="w-[212px] ml-[55px] max-[1250px]:mr-0 max-[550px]:mx-auto max-[1550px]:mx-auto max-[1250px]:w-1/2 max-[550px]:mt-8 flex flex-col justify-center">
            <div className="flex mx-auto h-[160px]">
